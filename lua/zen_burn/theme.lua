...
theme.set_highlights = function(opts)
    ...
    hl(0, 'DiffAdd', { fg = c.vscGreen, bg = "NONE" })
    ...
    hl(0, 'String', { fg = c.vscGreen, bg = 'NONE' })
    hl(0, 'Character', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, 'Number', { fg = c.vscGreen, bg = 'NONE' })
    hl(0, 'Boolean', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, 'Float', { fg = c.vscGreen, bg = 'NONE' })
    ...
    hl(0, 'jsRegexpString', { fg = c.vscGreen, bg = 'NONE' })
    ...
    hl(0, 'goFloats', { fg = c.vscGreen, bg = 'NONE' })
    hl(0, 'goComplexes', { fg = c.vscGreen, bg = 'NONE' })
