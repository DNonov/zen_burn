...
theme.set_highlights = function(opts)
    local c = require('zen_burn.colors').get_colors()
    ...
    hl(0, 'DiffAdd', { fg = c.vscBlueGreen, bg = "NONE" })
    hl(0, 'DiffChange', { fg = 'NONE', bg = c.vscDiffRedDark })
    hl(0, 'DiffDelete', { fg = c.vscRed, bg = "NONE" })
    ...
    hl(0, 'IncSearch', { fg = c.vscNone, bg = c.vscSelection })
    hl(0, 'LineNr', { fg = c.vscLineNumber, bg = c.vscBack })
    hl(0, 'CursorLineNr', { fg = c.vscFront, bg = c.vscBack })
    ...
    hl(0, 'Pmenu', { fg = c.vscPopupFront, bg = c.vscLeftDark })
    ...
    hl(0, 'Search', { fg = c.vscNone, bg = c.vscSelection })
    hl(0, 'QuickFixLine', { fg = c.vscRed, bg = c.Selection })
    ...
    hl(0, '@comment', { fg = c.vscGray, bg = 'NONE', italic = opts.italic_comments })
    hl(0, '@constant', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, '@constant.builtin', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, '@constant.macro', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, '@string.regex', { fg = c.vscOrange, bg = 'NONE' })
    hl(0, '@string', { fg = c.vscRed, bg = 'NONE' })
    hl(0, '@character', { fg = c.vscOrange, bg = 'NONE' })
    hl(0, '@number', { fg = c.vscRed, bg = 'NONE' })
    hl(0, '@boolean', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, '@float', { fg = c.vscOrange, bg = 'NONE' })
    hl(0, '@annotation', { fg = c.vscOrange, bg = 'NONE' })
    hl(0, 'decorated_definition.decorator', { fg = c.vscOrange, bg = 'NONE' })
    ...
    hl(0, '@function.builtin', { fg = c.vscDarkYellow, bg = 'NONE' })
    hl(0, '@function', { fg = c.vscDarkYellow, bg = 'NONE' })
    hl(0, '@function.macro', { fg = c.vscDarkYellow, bg = 'NONE' })
    hl(0, '@parameter', { fg = c.vscFront, bg = 'NONE' })
    hl(0, '@parameter.reference', { fg = c.vscFront, bg = 'NONE' })
    hl(0, '@method', { fg = c.vscDarkYellow, bg = 'NONE' })
    hl(0, '@field', { fg = c.vscFront, bg = 'NONE' })
    hl(0, '@property', { fg = c.vscFront, bg = 'NONE' })
    hl(0, '@constructor', { fg = c.vscDarkYellow, bg = 'NONE' })
    hl(0, '@conditional', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, '@repeat', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, '@label', { fg = c.vscFront, bg = 'NONE' })
    hl(0, '@keyword', { fg = c.vscBlue, bg = 'NONE' })
    ...
    hl(0, '@variable.builtin', { fg = c.vscFront, bg = 'NONE' })
    ...
    hl(0, '@tag.attribute', { fg = c.vscFront, bg = 'NONE' })
    ...
    -- JSON
    hl(0, 'jsonKeyword', { fg = c.vscFront, bg = 'NONE' })
    ...
    hl(0, 'phpMethod', { fg = c.vscDarkYellow, bg = 'NONE' })
    hl(0, 'phpClass', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, 'phpFunction', { fg = c.vscDarkYellow, bg = 'NONE' })
    hl(0, 'phpInclude', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, 'phpUseClass', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, 'phpRegion', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, 'phpMethodsVar', { fg = c.vscFront, bg = 'NONE' })

    -- CSS
    hl(0, 'cssBraces', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'cssInclude', { fg = c.vscPink, bg = 'NONE' })
    hl(0, 'cssTagName', { fg = c.vscDarkYellow, bg = 'NONE' })
    hl(0, 'cssClassName', { fg = c.vscDarkYellow, bg = 'NONE' })
    hl(0, 'cssPseudoClass', { fg = c.vscDarkYellow, bg = 'NONE' })
    hl(0, 'cssPseudoClassId', { fg = c.vscDarkYellow, bg = 'NONE' })
    hl(0, 'cssPseudoClassLang', { fg = c.vscDarkYellow, bg = 'NONE' })
    hl(0, 'cssIdentifier', { fg = c.vscDarkYellow, bg = 'NONE' })
    hl(0, 'cssProp', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'cssDefinition', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, 'cssAttr', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'cssAttrRegion', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'cssColor', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'cssFunction', { fg = c.vscDarkYellow, bg = 'NONE' })
    hl(0, 'cssFunctionName', { fg = c.vscOrange, bg = 'NONE' })
    hl(0, 'cssVendor', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'cssValueNumber', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, 'cssValueLength', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'cssUnitDecorators', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'cssStyle', { fg = c.vscLightBlue, bg = 'NONE' })
    hl(0, 'cssImportant', { fg = c.vscBlue, bg = 'NONE' })

    -- JavaScript
    hl(0, 'jsVariableDef', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'jsFuncArgs', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'jsFuncBlock', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'jsRegexpString', { fg = c.vscRed, bg = 'NONE' })
    hl(0, 'jsThis', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, 'jsOperatorKeyword', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'jsDestructuringBlock', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'jsObjectKey', { fg = c.vscFron, bg = 'NONE' })
    hl(0, 'jsGlobalObjects', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, 'jsModuleKeyword', { fg = c.vscFront, bg = 'NONE' })
    ...
    hl(0, 'jsExportDefault', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, 'jsFuncCall', { fg = c.vscDarkYellow, bg = 'NONE' })
    hl(0, 'jsObjectValue', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'jsParen', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'jsObjectProp', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'jsIfElseBlock', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'jsParenIfElse', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'jsSpreadOperator', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'jsSpreadExpression', { fg = c.vscFront, bg = 'NONE' })

    -- Typescript
    hl(0, 'typescriptLabel', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'typescriptExceptions', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'typescriptBraces', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'typescriptEndColons', { fg = c.vscFront, bg = 'NONE' })
    ...
    hl(0, 'typescriptLogicSymbols', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'typescriptImport', { fg = c.vscPink, bg = 'NONE' })
    hl(0, 'typescriptBOM', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'typescriptVariableDeclaration', { fg = c.vscFront, bg = 'NONE' })
    ...
    hl(0, 'typescriptOperator', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'typescriptArrowFunc', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, 'typescriptMethodAccessor', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, 'typescriptMember', { fg = c.vscOrange, bg = 'NONE' })
    hl(0, 'typescriptTypeReference', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, 'typescriptTemplateSB', { fg = c.vscYellowOrange, bg = 'NONE' })
    hl(0, 'typescriptArrowFuncArg', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'typescriptParamImpl', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'typescriptFuncComma', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'typescriptCastKeyword', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'typescriptCall', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, 'typescriptCase', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'typescriptReserved', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, 'typescriptDefault', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'typescriptDecorator', { fg = c.vscOrange, bg = 'NONE' })
    ...
    hl(0, 'typescriptDOMDocProp', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'typescriptTemplateSubstitution', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'typescriptClassBlock', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'typescriptFuncCallArg', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'typescriptIndexExpr', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'typescriptConditionalParen', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'typescriptArray', { fg = c.vscOrange, bg = 'NONE' })
    hl(0, 'typescriptES6SetProp', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'typescriptObjectLiteral', { fg = c.vscFront, bg = 'NONE' })
    ...
    hl(0, 'typescriptLoopParen', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'typescriptParenExp', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'typescriptModule', { fg = c.vscFront, bg = 'NONE' })
    ...
    hl(0, 'typescriptGlobalMethod', { fg = c.vscDarkYellow, bg = 'NONE' })
    hl(0, 'typescriptPromiseMethod', { fg = c.vscDarkYellow, bg = 'NONE' })
    ...
    hl(0, 'goSignedInts', { fg = c.vscPink, bg = 'NONE' })
    hl(0, 'goUnsignedInts', { fg = c.vscPink, bg = 'NONE' })
    hl(0, 'goFloats', { fg = c.vscPink, bg = 'NONE' })
    hl(0, 'goComplexes', { fg = c.vscPink, bg = 'NONE' })
    ...
    hl(0, 'goTodo', { fg = c.vscGray, bg = 'NONE' })
    ...
    hl(0, 'goFunctionCall', { fg = c.vscDarkYellow, bg = 'NONE' })
    hl(0, 'goMethodCall', { fg = c.vscDarkYellow, bg = 'NONE' })
    ...
    hl(0, 'pythonException', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, 'pythonExClass', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, 'pythonBuiltinObj', { fg = c.vscFront, bg = 'NONE' })
    ...
    hl(0, 'gitcommitSelectedType', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, 'gitcommitSelectedFile', { fg = c.vscBlueGreen, bg = 'NONE' })
    ...
    -- Lua
    hl(0, 'luaFuncCall', { fg = c.vscOrange, bg = 'NONE' })
    hl(0, 'luaFuncArgName', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'luaFuncKeyword', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, 'luaLocal', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, 'luaBuiltIn', { fg = c.vscBlue, bg = 'NONE' })

    -- SH
    hl(0, 'shDeref', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'shVariable', { fg = c.vscFront, bg = 'NONE' })

    -- SQL
    hl(0, 'sqlKeyword', { fg = c.vscBlue, bg = 'NONE' })
    hl(0, 'sqlFunction', { fg = c.vscDarkYellow, bg = 'NONE' })
    hl(0, 'sqlOperator', { fg = c.vscBlue, bg = 'NONE' })
    ...
    -- Gitgutter
    hl(0, 'GitGutterAdd', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, 'GitGutterChange', { fg = c.vscDarkYellow, bg = 'NONE' })
    hl(0, 'GitGutterDelete', { fg = c.vscRed, bg = 'NONE' })

    -- Git Signs
    hl(0, 'GitSignsAdd', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, 'GitSignsAdd', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, 'GitSignsChange', { fg = c.vscDarkYellow, bg = 'NONE' })
    hl(0, 'GitSignsDelete', { fg = c.vscRed, bg = 'NONE' })
    hl(0, 'GitSignsAddLn', { fg = c.vscBack, bg = c.vscBlueGreen })
    hl(0, 'GitSignsChangeLn', { fg = c.vscBack, bg = c.vscDarkYellow })
    hl(0, 'GitSignsDeleteLn', { fg = c.vscBack, bg = c.vscRed })

    -- NvimTree
    hl(0, 'NvimTreeRootFolder', { fg = c.vscFront, bg = 'NONE', bold = true })
    hl(0, 'NvimTreeGitDirty', { fg = c.vscDarkYellow, bg = 'NONE' })
    hl(0, 'NvimTreeGitNew', { fg = c.vscBlueGreen, bg = 'NONE' })
    ...
    hl(0, 'NvimTreeGitDeleted', { fg = c.vscGitRed, bg = 'NONE' })
    hl(0, 'NvimTreeGitStaged', { fg = c.vscGitStageModified, bg = 'NONE' })
    hl(0, 'NvimTreeGitMerge', { fg = c.vscGitUntracked, bg = 'NONE' })
    hl(0, 'NvimTreeBookmark', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, 'NvimTreeExecFile', { fg = c.vscRed, bg = 'NONE' })
    hl(0, 'NvimTreeOpenedFile', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'NvimTreeModifiedFile', { fg = c.vscFront, bg = 'NONE' })
    hl(0, 'NvimTreeGitDirty', { fg = c.vscGitFront, bg = 'NONE' })
    hl(0, 'NvimTreeGitNew', { fg = c.vscBlueGreen, bg = 'NONE' })
    ...
    hl(0, 'CmpItemKindFunction', { fg = c.vscDarkYellow, bg = 'NONE' })
    hl(0, 'CmpItemKindMethod', { fg = c.vscDarkYellow, bg = 'NONE' })
    ...
    hl(0, 'CmpItemKindConstructor', { fg = c.vscBlueGreen, bg = 'NONE' })
    ...
    hl(0, 'CmpItemAbbrMatch', { fg = isDark and c.vscLightBlue or c.vscDarkBlue, bg = 'NONE', bold = true })
    hl(0, 'CmpItemAbbrMatchFuzzy', { fg = isDark and c.vscLightBlue or c.vscDarkBlue, bg = 'NONE', bold = true })
    ...
    if isDark then
        hl(0, 'NvimTreeFolderIcon', { fg = c.vscFront, bg = 'NONE' })
        ...
        hl(0, 'TelescopeMatching', { fg = c.vscLightBlue, bg = 'NONE', bold = true })
        hl(0, 'TelescopePromptPrefix', { fg = c.vscFront, bg = 'NONE' })

        -- symbols-outline
        -- white fg and lualine blue bg
        hl(0, 'FocusedSymbol', { fg = '#ffffff', bg = c.vscPink })
        ...
        -- symbols-outline
        -- white fg and lualine blue bg
        hl(0, 'FocusedSymbol', { fg = c.vscBack, bg = c.vscPink })
